...
from tickets.models import validate_passport_data, validate_phone_number
...
class TrainSeatForm(forms.Form):
    seat_type_kupe = forms.BooleanField(
        label='Купе',
        required=False,
        widget=forms.RadioSelect,
    )
    seat_type_platzkart = forms.BooleanField(
        label='Плацкарт',
        required=False,
        widget=forms.RadioSelect,
    )
    seat_type_sv = forms.BooleanField(
        label='СВ',
        required=False,
        widget=forms.RadioSelect,
    )
